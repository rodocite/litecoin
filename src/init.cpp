...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/sojucoin-project/sojucoin>";
    const std::string URL_WEBSITE = "<https://sojucoin.org>";
