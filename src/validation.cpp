...
#if defined(NDEBUG)
# error "Sojucoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Sojucoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SJC additional fees, %d delta bytes\n",
