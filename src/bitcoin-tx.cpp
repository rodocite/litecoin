...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s sojucoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sojucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sojucoin transaction") + "\n" +
              "  sojucoin-tx [options] -create [commands]   " + _("Create hex-encoded sojucoin transaction") + "\n" +
              "\n";
