...
const char * const BITCOIN_CONF_FILENAME = "sojucoin.conf";
const char * const BITCOIN_PID_FILENAME = "sojucoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Sojucoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Sojucoin";
#else
    // Unix
    return pathRet / ".sojucoin";
#endif
#endif
}
